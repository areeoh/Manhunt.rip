...
class SocketClient {
    ...
    private void dataReceiveListener() {
        try {
            while (!socket.isClosed()) {
                ...
                SocketManager.Command command = SocketManager.Command.get(in.readByte());
                switch (command) {
                    case EXIT:
                    ...
                    case FORWARD_DATA:
                        ...
                        client.sendCommand(SocketManager.Command.SEND_DATA, "ForwardData", d);
                        break;
                    case CONNECT:
                        String p = in.readUTF();
                    ...
                    case PLAYER_COUNT:
                        ...
                        sendCommand(SocketManager.Command.SEND_DATA, "PlayerCount", player_count);
                        break;
                    case PLAYER_LIST:
                        ...
                        sendCommand(SocketManager.Command.SEND_DATA, "PlayerList", players);
                        break;
                    case GET_SERVERS:
                        ...
                        sendCommand(SocketManager.Command.SEND_DATA, "ServerList", servers);
                        break;
                    case MESSAGE:
                    ...
                    case GET_SERVER:
                        ...
                        sendCommand(SocketManager.Command.SEND_DATA, "ServerName", server_name);
                        break;
                    case KICK_PLAYER:
    ...
    void sendCommand(SocketManager.Command command, Object... data) {
        if (!identified) return;
        try {
            switch (command) {
                case EXIT:
